...
def test_en_yaml_completeness():
    ...
    package_dir = Path(__file__).parent.parent.parent.parent / "src" / "sigenergy2mqtt"
...
def test_translations_are_valid_yaml():
    translations_dir = Path(__file__).parent.parent.parent.parent / "src" / "sigenergy2mqtt" / "translations"
