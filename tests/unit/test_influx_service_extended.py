...
class TestParseTimestamp:
    """Test cases for _parse_timestamp edge cases."""
    ...
    def test_parse_iso_with_positive_offset(self, service):
        ...
        result = service._parse_timestamp("2024-01-15T16:00:00+05:30")
    ...
    def test_parse_with_milliseconds(self, service):
        ...
        result = service._parse_timestamp("2024-01-15T10:30:00.123Z")
...
class TestBuildTagFilters:
    ...
    def test_tag_with_special_characters(self, service):
        ...
        result = service._build_tag_filters({"entity_id": "sensor.my_test"})
        assert result == {"v1": "\"entity_id\"='sensor.my_test'"}

    def test_tag_with_spaces(self, service):
        """Build filters with spaces in tag values."""
        result = service._build_tag_filters({"device": "My Device"})
        assert result == {"v1": "\"device\"='My Device'"}


# =============================================================================
# _to_line_protocol tests (extended edge cases)
# =============================================================================


class TestToLineProtocolExtended:
    """Extended test cases for _to_line_protocol formatting."""

    def test_empty_tags(self, service):
        """Build line protocol with no tags."""
        line = service._to_line_protocol("measurement", {}, {"value": 42}, 1000)
    ...
    def test_empty_fields_handling(self, service):
        ...
        line = service._to_line_protocol("measurement", {"tag": "val"}, {}, 1000)
    ...
    def test_measurement_with_spaces(self, service):
        ...
        line = service._to_line_protocol("my measurement", {"tag": "val"}, {"value": 1}, 1000)
    ...
    def test_measurement_with_commas(self, service):
        ...
        line = service._to_line_protocol("meas,urement", {"tag": "val"}, {"value": 1}, 1000)
    ...
    def test_string_field(self, service):
        ...
        line = service._to_line_protocol("m", {}, {"status": "running"}, 1000)
    ...
    def test_string_field_with_quotes(self, service):
        ...
        line = service._to_line_protocol("m", {}, {"message": 'say "hello"'}, 1000)
    ...
    def test_multiple_mixed_fields(self, service):
        ...
        line = service._to_line_protocol("m", {}, {"count": 10, "temp": 25.5, "status": "ok"}, 1000)
...
class TestGetConfigValues:
    ...
    def test_basic_config_extraction(self, service, basic_config):
        ...
        result = service._get_config_values()
