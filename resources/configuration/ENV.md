...
| `SIGENERGY2MQTT_STATE_DIR` | The directory in which to store persistent state files (defaults: `/var/lib/sigenergy2mqtt` for Linux, `/data/state` for Docker and `/config/state` for Home Assistant) | 2026.2.23 |
