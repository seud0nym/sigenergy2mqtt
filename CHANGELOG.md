...
_NOTE: Includes all changes in 2026.3.21bx beta releases_
...
- New option to control the interval at which repeated state publishes are sent to MQTT
...
- New option to use Sigenergy-Local-Modbus naming, gain and unit conventions for mapped Modbus sensors (note that this option is incompatible with use-simplified-topics)
