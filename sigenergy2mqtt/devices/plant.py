...
class PowerPlant(ModbusDevice):
    def __init__(
        ...
        self._add_read_sensor(ro.PlantPhaseActivePower(plant_index, "A"), "Phase Power")
        self._add_read_sensor(ro.PlantPhaseReactivePower(plant_index, "A"), "Phase Power")
        if power_phases > 1:
            self._add_read_sensor(ro.PlantPhaseActivePower(plant_index, "B"), "Phase Power")
            self._add_read_sensor(ro.PlantPhaseReactivePower(plant_index, "B"), "Phase Power")
        if power_phases > 2:
            self._add_read_sensor(ro.PlantPhaseActivePower(plant_index, "C"), "Phase Power")
            self._add_read_sensor(ro.PlantPhaseReactivePower(plant_index, "C"), "Phase Power")
        self._add_read_sensor(ro.GeneralPCSAlarm(plant_index, ro.GeneralAlarm1(plant_index), ro.GeneralAlarm2(plant_index)), "Plant Alarms")
        self._add_read_sensor(ro.GeneralAlarm3(plant_index), "Plant Alarms")
        self._add_read_sensor(ro.GeneralAlarm4(plant_index), "Plant Alarms")
        if len(Config.devices[plant_index].dc_chargers) > 0:
            self._add_read_sensor(ro.GeneralAlarm5(plant_index), "Plant Alarms")
        self._add_read_sensor(ro.PlantActivePower(plant_index), "Phase Power")
        self._add_read_sensor(ro.PlantReactivePower(plant_index), "Phase Power")
