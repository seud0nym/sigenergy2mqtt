...
class PowerPlant(ModbusDevice):
    def __init__(
        ...
        super().__init__(device_type, name, plant_index, 247, "Energy Management System", protocol_version, sw=f"Modbus Protocol V{protocol_version.value}", translate=False)
