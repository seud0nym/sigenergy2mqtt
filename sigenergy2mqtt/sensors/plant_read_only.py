...
class PlantPhaseActivePower(ReadOnlySensor, HybridInverter, PVInverter):
    def __init__(self, plant_index: int, power_phases: int, phase: str):
        ...
        super().__init__(
            ...
            object_id=f"{Config.home_assistant.entity_id_prefix}_{plant_index}_plant_phase_{phase.strip().lower()}_active_power",
            input_type=InputType.INPUT,
            plant_index=plant_index,
            device_address=247,
            address=address,
...
class PlantPhaseReactivePower(ReadOnlySensor, HybridInverter, PVInverter):
    def __init__(self, plant_index: int, power_phases: int, phase: str):
        ...
        super().__init__(
            ...
            object_id=f"{Config.home_assistant.entity_id_prefix}_{plant_index}_plant_phase_{phase.strip().lower()}_reactive_power",
            input_type=InputType.INPUT,
            plant_index=plant_index,
            device_address=247,
            address=address,
